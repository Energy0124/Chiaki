...
namespace PixivCS
{
    public class PixivAppAPI : PixivBaseAPI
    {
        ...
        //用户详情
        public async Task<JsonDocument> UserDetail(string UserID, string Filter = "for_ios",
        ...
        //用户作品
        public async Task<JsonDocument> UserIllusts(string UserID, string IllustType = "illust",
        ...
        //用户收藏
        public async Task<JsonDocument> UserBookmarksIllust(string UserID, string Restrict = "public",
        ...
        //关注者的新作品
        public async Task<JsonDocument> IllustFollow(string Restrict = "public", string Offset = null,
            bool RequireAuth = true)
        {
        ...
        //作品详情
        public async Task<JsonDocument> IllustDetail(string IllustID, bool RequireAuth = true)
        {
        ...
        public async Task<JsonDocument> IllustComments(string IllustID, string Offset = null,
        ...
        //发表评论
        public async Task<JsonDocument> IllustCommentAdd(string IllustID, string Comment,
        ...
        //相关作品
        public async Task<JsonDocument> IllustRelated(string IllustID, string Filter = "for_ios",
        ...
        public async Task<JsonDocument> IllustRecommended(string ContentType = "illust",
        ...
        //date: yyyy-mm-dd
        public async Task<JsonDocument> IllustRanking(string Mode = "day", string Filter = "for_ios",
        ...
        //趋势标签
        public async Task<JsonDocument> TrendingTagsIllust(string Filter = "for_ios", bool RequireAuth = true)
        {
        ...
        public async Task<JsonDocument> SearchIllust(string Word, string SearchTarget = "partial_match_for_tags",
        ...
        //作品收藏详情
        public async Task<JsonDocument> IllustBookmarkDetail(string IllustID, bool RequireAuth = true)
        {
        ...
        //新增收藏
        public async Task<JsonDocument> IllustBookmarkAdd(string IllustID, string Restrict = "public",
        ...
        //删除收藏
        public async Task<JsonDocument> IllustBookmarkDelete(string IllustID, bool RequireAuth = true)
        {
        ...
        //用户收藏标签列表
        public async Task<JsonDocument> UserBookmarkTagsIllust(string Restrict = "public", string Offset = null,
            bool RequireAuth = true)
        {
        ...
        //Following用户列表
        public async Task<JsonDocument> UserFollowing(string UserID, string Restrict = "public",
        ...
        //Followers用户列表
        public async Task<JsonDocument> UserFollower(string UserID, string Restrict = "public",
            string Offset = null, bool RequireAuth = true)
        {
        ...
        //关注用户
        public async Task<JsonDocument> UserFollowAdd(string UserID, string Restrict = "public",
            bool RequireAuth = true)
        {
        ...
        //取关用户
        public async Task<JsonDocument> UserFollowDelete(string UserID, string Restrict = "public",
            bool RequireAuth = true)
        {
        ...
        //好P友
        public async Task<JsonDocument> UserMyPixiv(string UserID, string Offset = null,
            bool RequireAuth = true)
        {
        ...
        //黑名单用户
        public async Task<JsonDocument> UserList(string UserID, string Filter = "for_ios",
            string Offset = null, bool RequireAuth = true)
        {
        ...
        //Ugoira信息
        public async Task<JsonDocument> UgoiraMetadata(string IllustID, bool RequireAuth = true)
        {
        ...
        //特辑详情（伪装成Chrome）
        public async Task<JsonDocument> ShowcaseArticle(string ShowcaseID)
        {
